...
/*   Updated: 2025/01/17 11:18:36 by anastruc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::takeDamage(unsigned int amount)
{
    if (getHit_points() <= 0)
    {
        std::cout << "ClapTrap "<< getName() << " has been damaged but " << getName() << RED << " is already dead" << RESET << std::endl;
        return ;
    }    
    if ((getHit_points() - static_cast<int>(amount)) <= 0)
    {
